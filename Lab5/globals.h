...
typedef enum type {
    ...
    EXIT_ACK,       // logout acknowledgment
    ...
    LEAVE_ACK,      // leave session message type
    REGISTER,       // register the user in the database 
    REGISTER_ACK,   // register confirmed 
    REGISTER_NAK,   // register was unsuccessful   
    MESSAGE_ACK     // acknowledgement that the message has been received by the server 
} type;
