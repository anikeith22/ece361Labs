...
${OBJECTDIR}/_ext/55904c/deliver.o: ../../Lab2Submission/Section\ 3\ of\ Lab\ \(file\ transfer\)/deliver.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/55904c/deliver.o ../../Lab2Submission/Section\ 3\ of\ Lab\ \(file\ transfer\)/deliver.c
...
${OBJECTDIR}/_ext/1d1c0a54/server.o: ../../Lab2Submission/Section\ 3\ of\ Lab\ \(file\ transfer\)/serverfolder/server.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1d1c0a54/server.o ../../Lab2Submission/Section\ 3\ of\ Lab\ \(file\ transfer\)/serverfolder/server.c

${OBJECTDIR}/_ext/5c0/deliver.o: ../deliver.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/deliver.o ../deliver.c
